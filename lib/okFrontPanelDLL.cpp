...
// $Rev: 840 $ $Date: 2010-10-07 11:27:29 -0700 (Thu, 07 Oct 2010) $
//------------------------------------------------------------------------
...
std::string okCUsbFrontPanel::GetDeviceListSerial(int num)
	{
		...
		okUsbFrontPanel_GetDeviceListSerial(h, num, str);
...
std::string okCUsbFrontPanel::GetSerialNumber()
	{
		char str[MAX_SERIALNUMBER_LENGTH+1];
		okUsbFrontPanel_GetSerialNumber(h, str);
		return(std::string(str));
	}
std::string okCUsbFrontPanel::GetDeviceID()
	{
		char str[MAX_DEVICEID_LENGTH+1];
		okUsbFrontPanel_GetDeviceID(h, str);
		return(std::string(str));
	}
...
typedef void                   (DLL_ENTRY *OKUSBFRONTPANEL_GETDEVICELISTSERIAL_FN)              (okUSBFRONTPANEL_HANDLE, int, char *);
...
okDLLEXPORT void DLL_ENTRY
okUsbFrontPanel_GetDeviceListSerial(okUSBFRONTPANEL_HANDLE hnd, int num, char *str)
{
	if (_okUsbFrontPanel_GetDeviceListSerial)
		(*_okUsbFrontPanel_GetDeviceListSerial)(hnd, num, str);
}
